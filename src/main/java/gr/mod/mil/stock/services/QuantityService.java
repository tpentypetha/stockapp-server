...
public class QuantityService {
    ...
    public Quantity addQuantity(String cabinetid, String consumableid, int initialAmount)
        ...
        transactions.record(consumable, TransactionIndicator.DEPOSIT, initialAmount,"ΤΜΗΜΑ ΠΛΗΡΟΦΟΡΙΚΗΣ - ΕΠΙΚΟΙΝΩΝΙΩΝ - ΝΕΩΝ ΤΕΧΝΟΛΟΓΙΩΝ");
        return saved;
    }
    ...
    public Quantity submitCount(String quantityid, int amount,String dept_desc){
        Quantity quantity = quantities.findByPublicid(quantityid);
        ...
        transactions.record(quantity.getConsumable(), indicator, transaction_amount,dept_desc);
    ...
    public void RemoveQuantity(String quantityid){
        ...
        transactions.record(quantity.getConsumable(),TransactionIndicator.DELETE,quantity.getAmount(),"ΤΜΗΜΑ ΠΛΗΡΟΦΟΡΙΚΗΣ - ΕΠΙΚΟΙΝΩΝΙΩΝ - ΝΕΩΝ ΤΕΧΝΟΛΟΓΙΩΝ");
